			...
			<div class="header-wrap">
							...
							?>
								<nav id="primary-navigation" class="site-navigation primary-navigation" role="navigation">
									<div class="nav-menu">
										<ul>
											<li>
												<a class="search-toggle"><i class="pe-7s-search"></i><?php esc_html_e('Search', 'read'); ?></a>
											</li>
										</ul>
									</div>
								</nav>
							...
							?>
								<nav id="primary-navigation" class="site-navigation primary-navigation" role="navigation">
									<div class="nav-menu">
										<ul>
											<li>
												<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><i class="pe-7s-home"></i><?php esc_html_e('Home', 'read'); ?></a>
											</li>
											<li>
												<a class="search-toggle"><i class="pe-7s-search"></i><?php esc_html_e('Search', 'read'); ?></a>
											</li>
							...
							<nav id="primary-navigation" class="site-navigation primary-navigation" role="navigation">
								<div class="nav-menu">
									<ul>
										...
										<li>
											<a href="<?php echo esc_url( get_home_url() . '/#/' . $pixelwars__portfolio_page_slug ); ?>"><i class="pe-7s-back"></i><?php esc_html_e('Back To Portfolio', 'read'); ?></a>
										</li>
										<li>
											<a class="search-toggle"><i class="pe-7s-search"></i><?php esc_html_e('Search', 'read'); ?></a>
										</li>
											...
											<?php
												...
												if ($back_to_blog_link_behaviour == 'to_grid_blog')
												{
													...
													if ($blog_page_slug != "")
													{
														...
														?>
															<li>
																<a href="<?php echo esc_url($blog_page_url); ?>"><i class="pe-7s-back"></i><?php esc_html_e('Back To Blog', 'read'); ?></a>
															</li>
														<?php
													}
												}
				...
				<div class="header-search">
					<form role="search" id="search-form" method="get" action="<?php echo esc_url(home_url('/')); ?>">
						<input type="text" id="search" name="s" required="required" placeholder="<?php esc_attr_e('enter word', 'read'); ?>">
						<input type="submit" id="search-submit" title="<?php esc_attr_e('Search', 'read'); ?>" value="&#8594;">
					</form>
				</div>
