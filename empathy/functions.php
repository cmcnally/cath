...
/* ============================================================================================================================================= */
	...
	function pixelwars__theme_setup()
	{
	...
	add_action( 'after_setup_theme', 'pixelwars__theme_setup' );
...
/* ============================================================================================================================================= */
	...
	{
		return '... <p class="more"><a class="more-link" href="' . get_permalink( get_the_ID() ) . '">' . __( 'Read More', 'read' ) . '</a></p>';
	}
...
/* ============================================================================================================================================= */
	...
	{
		register_nav_menus( array(  'pixelwars__theme_menu_location_1' => __( 'Classic Navigation Menu', 'read' ) ) );
	}
					...
					<li id="li-comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
						<article id="comment-<?php comment_ID(); ?>" class="comment">
							<header class="comment-meta comment-author vcard">
								...
								<span class="comment-date"><?php echo get_comment_date() . ' ' . __( 'at', 'read' ) . ' ' . get_comment_time(); ?></span>
							</header>
							...
							<section class="comment-content comment">
								...
								<?php
									edit_comment_link( __( 'Edit', 'read' ), '<p class="comment-edit-link">', '</p>' );
								?>
							</section>
							...
							<div class="reply">
								<?php
									comment_reply_link( array_merge( $args, array(  'reply_text' => __( 'Reply', 'read' ),
																					'after'      => "",
																					'depth'      => $depth,
...
/* ============================================================================================================================================= */
	...
	if ( function_exists( 'register_sidebar' ) )
	{
		...
		register_sidebar( array('name'          => __( 'Footer Social Icons', 'read' ),
								...
								'description'   => 'Use social media shortcodes with the Text widget in this widget area to add icons to your site footer.',
								'before_widget' => "",
								'after_widget'  => "",
		...
		register_sidebar( array('name'          => __( 'Footer Copyright Text', 'read' ),
								'id'            => 'pixelwars__sidebar_3',
								'description'   => __( 'Use Text widget in here.', 'read' ),
		...
		register_sidebar( array('name'          => __( 'Empathy Template Pages', 'read' ),
								'id'            => 'pixelwars__sidebar_1',
								'description'   => __( 'Add only Empathy [PAGE] widgets.', 'read' ),
								'before_widget' => "",
								'after_widget'  => "",
								'before_title'  => '<span style="display: none;">',
								'after_title'   => '</span>' ) );
...
/* ============================================================================================================================================= */
	...
	class pixelwars__Widget__Custom_Page extends WP_Widget
	{
		...
		{
			parent::__construct('pixelwars__widget__custom_page',
								__( '(Empathy) [PAGE] Custom', 'read' ),
								array( 'description' => __( 'About, resume, contact etc.', 'read' ) ) );
		}
			...
			?>
				<table style="width: 100%; margin-top: 5px;">
					...
					<tr>
						...
						<td>
							<span style="display: inline-block; margin-bottom: 5px; font-size: 11px; color: #999999;"><?php echo __('For menu item.', 'read'); ?></span>
						</td>
					</tr>
					<tr>
						<td>
							<label for="<?php echo $this->get_field_id( 'icon' ); ?>"><?php echo __( 'Icon', 'read' ); ?></label>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<span style="display: inline-block; margin-bottom: 5px; font-size: 11px; color: #999999;"><?php echo __('For page icon and menu icon.', 'read'); ?> <?php echo __('Use icon name.', 'read'); ?> <?php echo __('Available', 'read'); ?> <a target="_blank" href="http://themes-pixeden.com/font-demos/7-stroke/"><?php echo __('icons', 'read'); ?></a>.</span>
						</td>
					</tr>
					<tr>
						<td>
							<label for="<?php echo $this->get_field_id( 'custom_page_slug' ); ?>"><?php echo __( 'Page', 'read' ); ?></label>
						</td>
						<td>
							<select class="widefat" id="<?php echo $this->get_field_id( 'custom_page_slug' ); ?>" name="<?php echo $this->get_field_name( 'custom_page_slug' ); ?>">
								<option>&mdash; <?php echo __('Select', 'read'); ?> &mdash;</option>
								<?php
									$pages = get_pages();
					...
					<tr>
						...
						<td>
							<span style="font-size: 11px; color: #999999;"><?php echo __('Select a page for this widget.', 'read'); ?></span>
						</td>
					</tr>
				</table>
	...
	add_action( 'widgets_init', create_function( '', 'register_widget( "pixelwars__widget__custom_page" );' ) );
...
/* ============================================================================================================================================= */
	...
	class pixelwars__Widget__Home extends WP_Widget
	{
		public function __construct()
		{
			parent::__construct('pixelwars__widget__home',
								__('(Empathy) [PAGE] Home', 'read'),
								array('description' => __('Intro page.', 'read')));
		}
		...
		public function form($instance)
		{
			...
			if (isset($instance['custom_page_slug'])) { $custom_page_slug = $instance['custom_page_slug']; } else { $custom_page_slug = ""; }
			if (isset($instance['icon'])) { $icon = $instance['icon']; } else { $icon = ""; }
			if (isset($instance['background_video'])) { $background_video = $instance['background_video']; } else { $background_video = ""; }
			...
			?>
				<table style="width: 100%; margin-top: 5px;">
					...
					<tr>
						...
						<td>
							<span style="display: inline-block; font-size: 11px; color: #999999;"><?php echo __('Select a page for this widget. Set featured image to selected page for background image.', 'read'); ?></span>
						</td>
					</tr>
				</table>
				<table style="width: 100%; margin-top: 5px;">
					<tr>
						<td>
							<label for="<?php echo esc_attr($this->get_field_id('background_video')); ?>"><?php esc_html_e('Background Video', 'theblogger'); ?></label>
						</td>
					</tr>
					<tr>
						<td>
							<input type="text" class="widefat" id="<?php echo esc_attr($this->get_field_id('background_video')); ?>" name="<?php echo esc_attr($this->get_field_name('background_video')); ?>" value="<?php echo esc_url($background_video); ?>">
							<span style="font-size: 11px; color: #999999;"><?php esc_html_e('Use browser address url of a video from YouTube or Vimeo.', 'theblogger'); ?></span>
						</td>
					</tr>
				</table>
	...
	add_action('widgets_init', create_function('', 'register_widget("pixelwars__widget__home");'));
...
/* ============================================================================================================================================= */
	...
	class pixelwars__Widget__Blog extends WP_Widget
	{
		public function __construct()
		{
			parent::__construct('pixelwars__widget__blog',
								__( '(Empathy) [PAGE] Blog', 'read' ),
								array( 'description' => __( 'Latest blog posts.', 'read' ) ) );
		}
		...
		public function form( $instance )
		{
			...
			if ( isset( $instance[ 'blog_item_width' ] ) ) { $blog_item_width = $instance[ 'blog_item_width' ]; } else { $blog_item_width = '340'; }
			if ( isset( $instance[ 'blog_number_of_posts' ] ) ) { $blog_number_of_posts = $instance[ 'blog_number_of_posts' ]; } else { $blog_number_of_posts = '9'; }
			...
			?>
				<table style="width: 100%; margin-top: 5px;">
					...
					<tr>
						<td>
							<label for="<?php echo $this->get_field_id( 'blog_page_slug' ); ?>"><?php echo __( 'Page', 'read' ); ?></label>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<span style="display: inline-block; margin-bottom: 5px; font-size: 11px; color: #999999;"><?php echo __('Select a page for this widget.', 'read'); ?></span>
						</td>
					</tr>
					<tr>
						<td>
							<label for="<?php echo $this->get_field_id( 'layout' ); ?>"><?php echo __( 'Layout', 'read' ); ?></label>
						</td>
						<td>
				...
				<table style="width: 100%; margin-top: 5px;">
					<tr>
						<td style="width: 80px;">
							<label for="<?php echo $this->get_field_id( 'blog_item_width' ); ?>"><?php echo __( 'Item Width', 'read' ); ?></label>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<span style="display: inline-block; margin-bottom: 5px; font-size: 11px; color: #999999;"><?php echo __('Default: 340 (px)', 'read'); ?></span>
						</td>
					</tr>
					<tr>
						<td>
							<label for="<?php echo $this->get_field_id( 'blog_number_of_posts' ); ?>"><?php echo __( 'Show Items', 'read' ); ?></label>
						</td>
						<td>
	...
	add_action('widgets_init', create_function('', 'register_widget("pixelwars__widget__blog");'));
...
/* ============================================================================================================================================= */
	...
	class pixelwars__Widget__Portfolio extends WP_Widget
	{
		public function __construct()
		{
			parent::__construct('pixelwars__widget__portfolio',
								__( '(Empathy) [PAGE] Portfolio', 'read' ),
		...
		public function form( $instance )
		{
			...
			?>
				<table style="width: 100%; margin-top: 5px;">
					...
					<tr>
						<td>
							<label for="<?php echo $this->get_field_id( 'portfolio_page_slug' ); ?>"><?php echo __( 'Page', 'read' ); ?></label>
						</td>
						<td>
				...
				<table style="width: 100%; margin-top: 5px;">
					<tr>
						<td style="width: 80px;">
							<label for="<?php echo $this->get_field_id( 'item_width' ); ?>"><?php echo __( 'Item Width', 'read' ); ?></label>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<span style="font-size: 11px; color: #999999;"><?php echo __('Default: 340 (px)', 'read'); ?></span>
						</td>
					</tr>
				</table>
										...
										?>
											<ul id="filters" class="filters">
												<?php
													...
													{
														?>
															<li class="current"><a href="#" data-filter="*"><?php _e('All', 'read'); ?></a></li>
														<?php
													}
												...
												<?php
													...
													if ( $loop_portfolio->have_posts() ) :
														...
														while ( $loop_portfolio->have_posts() ) : $loop_portfolio->the_post();
															...
															if ( $pf_type == 'Lightbox Gallery' ) { $pf_type_icon = 'image'; }
															elseif ( $pf_type == 'Lightbox Audio' ) { $pf_type_icon = 'audio'; }
															elseif ( $pf_type == 'Lightbox Video' ) { $pf_type_icon = 'video'; }
															elseif ( $pf_type == 'Direct URL' ) { $pf_type_icon = 'url'; }
	...
	add_action( 'widgets_init', create_function( '', 'register_widget( "pixelwars__widget__portfolio" );' ) );
...
/* ============================================================================================================================================= */
	...
	{
		extract( shortcode_atts( array( 'align' => 'center',
										'text'  => "" ), $atts ) );
...
/* ============================================================================================================================================= */
	...
	function contact_form($atts, $content = "")
	{
		...
		$output .= '<p class="antispam"><label for="url">' . __('Leave this empty', 'read') . '</label><input type="text" id="url" name="url"></p>';
	...
	function pixelwars__archive_title()
	{
			...
			?>
				<header class="entry-header">
					<div class="section-title center">    
						<h2><i><?php echo __( 'Category', 'read' ); ?></i></h2>
					</div>
		...
		elseif ( is_tag() )
		{
			?>
				<header class="entry-header">
					<div class="section-title center">    
						<h2><i><?php echo __( 'Posts Tagged', 'read' ); ?></i></h2>
					</div>
		...
		elseif ( is_author() )
		{
			?>
				<header class="entry-header">
					<div class="section-title center">    
						<h2><i><?php echo __( 'Posts By', 'read' ); ?></i></h2>
					</div>
		...
		elseif ( is_search() )
		{
			?>
				<header class="entry-header">
					<div class="section-title center">    
						<h2><i><?php echo __( 'Searched For', 'read' ); ?></i></h2>
					</div>
		...
		elseif ( is_date() )
		{
			?>
				<header class="entry-header">
					<div class="section-title center">    
						<h2><i><?php echo __( 'Date Archives', 'read' ); ?></i></h2>
					</div>
		...
		elseif ( is_post_type_archive() )
		{
			?>
				<header class="entry-header">
					<div class="section-title center">    
						<h2><i><?php echo __( 'Archives', 'read' ); ?></i></h2>
					</div>
	...
	function pixelwars__content()
	{
		if ( is_home() || is_archive() || is_search() )
		{
			if ( has_excerpt() )
			{
				...
				echo '<p class="more"><a class="more-link" href="' . get_permalink( get_the_ID() ) . '">' . __( 'Read More', 'read' ) . '</a></p>';
			}
			else
			{
			...
			if ( $query->have_posts() )
			{
				?>
					<div class="related-posts">
						<div class="section-title center">
							<h2>
								<i><?php echo __( 'You May Also Like', 'read' ); ?></i>
							</h2>
						</div>
		...
		else
		{
			?>
				<nav class="row nav-single">
					<div class="col-sm-6 nav-previous">
						<?php
							previous_post_link( '<h6>' . __( 'PREVIOUS POST', 'read' ) . '</h6><h5>%link</h5>', '<span class="meta-nav">&#8592;</span> %title' );
						?>
					</div>
					
					<div class="col-sm-6 nav-next">
						<?php
							next_post_link( '<h6>' . __( 'NEXT POST', 'read' ) . '</h6><h5>%link</h5>', '%title <span class="meta-nav">&#8594;</span>' );
						?>
					</div>
				</nav>
			<?php
...
/* ============================================================================================================================================= */
	...
	function pixelwars__customize_register( $wp_customize )
	{
		$wp_customize->add_section( 'pixelwars__section_fonts', array(  'title'    => __( 'Fonts', 'read' ),
																		'priority' => 30 ) );
		
		
		$wp_customize->add_section( 'pixelwars__section_colors' , array(    'title'    => __( 'Colors', 'read' ),
																			'priority' => 31 ) );
		
		
		$wp_customize->add_section( 'pixelwars__section_colors_2' , array(  'title'       => __( 'Empathy Page Colors', 'read' ),
																			'description' => __( 'Select background color for pages in the Empathy page template.', 'read' ),
																			'priority'    => 32 ) );
		
		
		$wp_customize->add_section( 'pixelwars__section_animation' , array( 'title'       => __( 'Empathy Page Animations', 'read' ),
																			'description' => __( 'Select page transition effects for pages in the Empathy page template.', 'read' ),
																			'priority'    => 33 ) );
		
		
		$wp_customize->add_section( 'pixelwars__section_custom_css', array( 'title'       => __( 'Custom CSS', 'read' ),
																			'description' => __( 'Quickly add custom css.', 'read' ),
																			'priority'    => 34 ) );
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pixelwars__control_color_1', array(	'label'    => __( 'Text Logo Color', 'read' ),
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pixelwars__control_color_2', array( 'label'    => __( 'Text Logo Background Color', 'read' ),
																														'section'  => 'pixelwars__section_colors',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pixelwars__control_color_3', array( 'label'    => __( 'Menu Background Color', 'read' ),
																														'section'  => 'pixelwars__section_colors',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pixelwars__control_color_4', array( 'label'    => __( 'Link Color', 'read' ),
																														'section'  => 'pixelwars__section_colors',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pixelwars__control_color_5', array( 'label'    => __( 'Link Hover Color', 'read' ),
																														'section'  => 'pixelwars__section_colors',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pixelwars__control_color_6', array( 'label'    => __( 'Primary Color', 'read' ),
																														'section'  => 'pixelwars__section_colors',
		...
		$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize,
																  ...
																  array('label'    => __('Loading Bar Color', 'read'),
																		'section'  => 'pixelwars__section_colors',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pixelwars__control_color_7', array( 'label'    => __( '1. Page Background Color', 'read' ),
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pixelwars__control_color_8', array( 'label'    => __( '2. Page Background Color', 'read' ),
																														'section'  => 'pixelwars__section_colors_2',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pixelwars__control_color_9', array( 'label'    => __( '3. Page Background Color', 'read' ),
																														'section'  => 'pixelwars__section_colors_2',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pixelwars__control_color_10', array(    'label'    => __( '4. Page Background Color', 'read' ),
																															'section'  => 'pixelwars__section_colors_2',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pixelwars__control_color_11', array(    'label'    => __( '5. Page Background Color', 'read' ),
																															'section'  => 'pixelwars__section_colors_2',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pixelwars__control_color_12', array(    'label'    => __( '6. Page Background Color', 'read' ),
																															'section'  => 'pixelwars__section_colors_2',
		...
		$wp_customize->add_control( 'pixelwars__control_custom_css', array( 'label'    => __( 'Custom CSS', 'read' ),
	...
	add_action( 'customize_register', 'pixelwars__customize_register' );
...
<style type="text/css">
.site-title { font-family: "<?php echo $pixelwars__setting_font_1; ?>"; }
</style>
			<?php
		}
...
<style type="text/css">
.nav-menu { font-family: "<?php echo $pixelwars__setting_font_2; ?>"; }
</style>
			<?php
		}
...
<style type="text/css">
h1, h2, h3, h4, h5, h6, .filters, th, dt, .button, input[type=submit], button, label, .tab-titles { font-family: "<?php echo $pixelwars__setting_font_3; ?>"; }
</style>
			<?php
		}
...
<style type="text/css">
body, input, textarea, select { font-family: "<?php echo $pixelwars__setting_font_4; ?>"; }
</style>
			<?php
		}
...
<!-- Text Logo Color -->
<style type="text/css">
.site-title { color: <?php echo $pixelwars__setting_color_1; ?>; }
</style>
			<?php
		}
...
<style type="text/css">
@media screen and (min-width: 768px) { .site-title { background: <?php echo $pixelwars__setting_color_2; ?>; } }
</style>
			<?php
		}
...
<style type="text/css">
.header, .header-wrap { background: <?php echo $pixelwars__setting_color_3; ?>; }
</style>
			<?php
		}
...
<!-- Link Color -->
<style type="text/css">
a { color: <?php echo $pixelwars__setting_color_4; ?>; }
</style>
			<?php
		}
...
<!-- Link Hover Color -->
<style type="text/css">
a:hover { color: <?php echo $pixelwars__setting_color_5; ?>; }
</style>
			<?php
		}
...
<!-- Primary Color -->
<style type="text/css">
input[type=submit]:hover, input[type=button]:hover, button:hover, a.button:hover, .event h3, .event h2 + p i, .event h2 + p img, #search-submit, .entry-meta .cat-links a, .pagination a:hover, .navigation a:hover, a.more-link:hover, .section-title h2 i, .event:nth-of-type(2):after { background-color: <?php echo $pixelwars__setting_color_6; ?>; }

.bypostauthor > article { border-color: <?php echo $pixelwars__setting_color_6; ?>; }

.event h3:before { border-color: <?php echo $pixelwars__setting_color_6; ?>; }
</style>
...
<!-- Link Hover Color -->
<style type="text/css">
#nprogress .bar { background-color: <?php echo $pixelwars__setting_color_progress_bar; ?>; }
#nprogress .spinner-icon { border-top-color: <?php echo $pixelwars__setting_color_progress_bar; ?>; border-left-color: <?php echo $pixelwars__setting_color_progress_bar; ?>; }
</style>
			<?php
		}
...
<style type="text/css">
.one-page-layout .site-main > section:nth-of-type(1) { background-color: <?php echo $pixelwars__setting_color_7; ?>; }
</style>
			<?php
		}
...
<style type="text/css">
.one-page-layout .site-main > section:nth-of-type(2) { background-color: <?php echo $pixelwars__setting_color_8; ?>; }
</style>
			<?php
		}
...
<style type="text/css">
.one-page-layout .site-main > section:nth-of-type(3) { background-color: <?php echo $pixelwars__setting_color_9; ?>; }
</style>
			<?php
		}
...
<style type="text/css">
.one-page-layout .site-main > section:nth-of-type(4) { background-color: <?php echo $pixelwars__setting_color_10; ?>; }
</style>
			<?php
		}
...
<style type="text/css">
.one-page-layout .site-main > section:nth-of-type(5) { background-color: <?php echo $pixelwars__setting_color_11; ?>; }
</style>
			<?php
		}
...
<style type="text/css">
.one-page-layout .site-main > section:nth-of-type(6) { background-color: <?php echo $pixelwars__setting_color_12; ?>; }
</style>
			<?php
		}
...
/* ============================================================================================================================================= */
	...
	function pixelwars__plugins()
	{
		$plugins = array( array('name'               => esc_html__('Pixelwars Portfolio', 'read'),
						  ...
						  array('name'     => esc_html__('One Click Demo Import', 'read'),
								'slug'     => 'one-click-demo-import',
								'required' => false));
		
		$config = array('id'           => 'empathy_tgmpa',
						'default_path' => "",
...
/* ============================================================================================================================================= */
	...
	function pixelwars__ocdi_import_files()
	{
	...
	add_filter('pt-ocdi/import_files', 'pixelwars__ocdi_import_files');
