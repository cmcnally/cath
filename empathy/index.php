				...
				<?php
									...
									<header class="entry-header">
										...
										<div class="entry-meta">
											...
											<span class="comment-link">
												<?php
													comments_popup_link( __( '0 Comment', 'read' ), __( '1 Comment', 'read' ), __( '% Comments', 'read' ), "", 'Comments Off' );
												?>
											</span>
					...
					elseif ( is_search() ) :
						...
						?>
							<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
								<header class="entry-header">
									<h2 class="entry-title"><?php _e( 'Nothing Found', 'read' ); ?></h2>
								</header>
								
								<div class="entry-content">
									<p>
										<?php
											_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'read' );
										?>
									</p>
						...
						?>
							<article id="post-<?php the_ID(); ?>" <?php post_class( 'blog-no-posts' ); ?>>
								...
								<div class="entry-content">
									<p>
										<?php
											_e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'read' );
										?>
									</p>
